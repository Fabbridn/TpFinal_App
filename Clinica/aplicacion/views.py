...
def Agregar_Doctor(request):
    if request.method == "POST":
        ...
        form = DoctorForm()
    return render(request, "clinica/Agregar_doctor.html", {"form": form})
...
def Buscar_Doctor(request):
    ...
    return render(request, "clinica/Buscar_Doctor.html", {"resultados": resultados})
...
def Agregar_Paciente(request):
    if request.method == "POST":
        ...
        form = PacienteForm()
    return render(request, "hospital/Agregar_Paciente.html", {"form": form})

def Buscar_Paciente(request):
    query = request.GET.get('nombre', '')
    resultados = Paciente.objects.filter(nombre__icontains=query) if query else None
    return render(request, "hospital/Buscar_Paciente.html", {"resultados": resultados})
#--------------------------------------------------------------------------------------------#
